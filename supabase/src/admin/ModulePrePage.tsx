...
export const COMING_SOON_MODULES: ModulePre[] = [
  ...
  { key: "ticketing", name: "Events / Ticketing", badge: "ET", tagline: "Sell tickets and manage events end to end.", summary: "Create events, sell tickets, scan entry and reconcile takings.", overview: ["Paid and free tickets with QR entry scanning.", "Attendance and break-even reporting built in."], quickstart: [{ title: "Create an event", body: "Set the date, venue and ticket types." }], plan: "Add module to plan" },
